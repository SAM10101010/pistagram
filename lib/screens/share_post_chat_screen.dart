...
class SharePostChatScreen extends StatefulWidget {
  final String postId;
  const SharePostChatScreen({super.key, required this.postId});

  @override
  State<SharePostChatScreen> createState() => _SharePostChatScreenState();
}

class _SharePostChatScreenState extends State<SharePostChatScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text('Share Post', style: GoogleFonts.outfit(fontWeight: FontWeight.bold, color: textColor)),
