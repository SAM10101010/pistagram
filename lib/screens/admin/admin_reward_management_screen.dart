...
class _AdminRewardManagementScreenState
  ...
  void _showAddEditDialog({RewardModel? existing}) {
    ...
    final costC = TextEditingController(
      text: existing?.pointsCost.toString() ?? '',
    );
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        title: Text(
          existing == null ? 'Add Reward' : 'Edit Reward',
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              '${reward.pointsCost} pts • Stock: ${reward.stock > 0 ? reward.stock : '∞'}',
                              style: GoogleFonts.inter(
                                fontSize: 12,
                                color: subColor,
                              ),
                      ...
                      IconButton(
                        icon: Icon(
                          ...
                          color: reward.isActive ? Colors.green : subColor,
                          size: 32,
                        ),
